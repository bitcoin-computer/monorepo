...
const opts = Object.assign({ mnemonic: 'opera deputy attitude upset royal keep' }, randomOpts);
describe('BRC721', () => {
    describe('Constructor', () => {
        ...
        it('should create a smart object', () => __awaiter(void 0, void 0, void 0, function* () {
            const computer = new Computer(opts);
            const publicKeyString = computer.getPublicKey();
            const nft = yield computer.new(BRC721, [publicKeyString, 'name', 'symbol']);
    ...
    describe('transfer', () => {
        it('Should update a smart object', () => __awaiter(void 0, void 0, void 0, function* () {
            const computer = new Computer(opts);
            const publicKeyString = computer.getPublicKey();
            ...
            expect(nft._rev).to.be.a('string');
            expect(nft._root).to.be.a('string');
            yield nft.transfer(publicKeyString2, 1);
