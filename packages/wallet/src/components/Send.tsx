...
import { Auth, strToBigInt, UtilsContext } from '@bitcoin-computer/components'
  ...
  return (
    <>
      <h4 className="mb-4 text-2xl font-bold dark:text-white">
        ...
        <HiRefresh
          onClick={updateTxs}
          className="w-4 h-4 ml-2 inline cursor-pointer dark:text-gray-400 hover:text-slate-700 dark:hover:text-slate-100"
        />
      </h4>
