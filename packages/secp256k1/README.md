<div align="center">
  <h1>secp256k1</h1>
  <p>
    A fork of [tiny-secp256k1](https://github.com/bitcoinjs/tiny-secp256k1) library
  </p>
</div>
...
% docker run -it --rm -v `pwd`:/secp256k1 -w /secp256k1 secp256k1
# make build
```

## Examples

`secp256k1` includes two examples. First is [simple script for Node.js](examples/random-in-node) which generate random data and print arguments and methods results. Second is [React app](examples/react-app).
