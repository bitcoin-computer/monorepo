...
export const WOJAK: ChainConfig = {
  chain: 'WOJAK',
  defaults: {
    satPerByte: 2,
    dustRelayTxFee: 3000,
...
export const BUILTIN_CONFIGS: ChainConfig[] = [LTC, BTC, DOGE, PEPE, WOJAK];
