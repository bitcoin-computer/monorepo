  ...
  return (
    <>
      {utxos && utxos.length > 0 && (
        <>
          <div className="p-4 rounded-3xl shadow-md bg-white dark:bg-gray-800 transition-colors">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">
              Address: {address}
            </h2>
            <p className="text-m text-gray-700 dark:text-gray-300 mt-2">
              <span className="font-medium">Total Amount:</span> {totalAmount} {computer.getChain()}
            </p>
          </div>
