    ...
    >
        ...
        <Grid container sx={{ zIndex: 3 }} className="example-grid-wrapper">
          <Grid item xs={4} className="infoGridExample">
            ...
            <Box className="example-1-subtext-tab">
              A non-fungible token is an object that stores an image url, the title of an artwork,
              and the name of a artist.
            </Box>
            <br />
            <Box className="example-1-subtext-tab">
      ...
      <TabPanel value={value} index={2}>
        <Grid container sx={{ zIndex: 3 }} className="example-grid-wrapper">
          <Grid item xs={4} className="infoGridExample">
            <Box className="example-1-subtext-tab">
              A chat is an object that stores a list of messages that is initially empty. It has a
