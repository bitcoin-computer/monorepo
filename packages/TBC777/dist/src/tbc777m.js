...
export class TBC777M extends TBC20 {
    ...
    static async computeWithdraw(rev, _id, _root) {
        ...
        // @ts-ignore
        (total, [root, id, amount]) => (root === _root && id === _id ? total + amount : total), 0n);
    }
    /**
     * Returns the amount this specific token instance (`_id`) is allowed to
    ...
    static async computeDeposits(states, root) {
        ...
        // @ts-ignore
        deposits.map((deposit) => TBC777M.computeDeposit(deposit, escrowId, root)));
        // @ts-ignore
...
//# sourceMappingURL=tbc777m.js.map