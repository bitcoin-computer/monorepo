            ...
            <div>
              <form onSubmit={handleSubmit} className="p-10 border ">
                ...
                <button
                  ...
                  type="submit"
                  value="Send Litecoin"
                  className="text-white  bg-blue-600 hover:bg-blue-700 rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >
                  Create Artwork
                </button>
              </form>
