...
export const ModalComponent = ({
  ...
  <div
    ...
    aria-hidden="true"
    style={{ zIndex: 45 }}
    className="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 justify-center items-center w-full inset-0 h-[calc(100%-1rem)] max-h-full p-2 sm:p-0"
  >
    <div className="relative p-2 sm:p-4 w-full max-w-sm max-h-full">
