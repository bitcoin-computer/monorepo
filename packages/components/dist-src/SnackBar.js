...
export function SnackBar(props) {
    var _this = this;
    var message = props.message, success = props.success, setShow = props.setShow, callback = props.callback;
    ...
    return (_jsxs("div", __assign({ className: success
            ...
            : "bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded fixed bottom-2 right-2", role: "alert" }, { children: [_jsx("strong", __assign({ className: "font-bold pr-6" }, { children: message })), _jsx("span", __assign({ className: "absolute top-0 bottom-0 right-0 px-4 py-3", onClick: closeMessage }, { children: _jsxs("svg", __assign({ className: success
