...
export const SmartObjectFunctions = ({ smartObject, functionsExist, options, setFunctionResult, setShow, setModalTitle, }) => {
    ...
    return (_jsxs("section", { className: "rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-sm overflow-hidden", "aria-label": "Methods", children: [_jsxs("div", { className: "px-4 py-3 border-b border-gray-200 dark:border-gray-700 flex flex-wrap items-center justify-between gap-2", children: [_jsxs("div", { children: [_jsx("h2", { className: "text-base sm:text-lg font-semibold text-gray-900 dark:text-white", children: "Methods" }), _jsxs("p", { className: "text-xs text-gray-500 dark:text-gray-400 mt-0.5", children: [methods.length, " method", methods.length === 1 ? '' : 's', " \u00B7 select one to call"] })] }), _jsx("span", { className: "inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium bg-blue-50 text-blue-800 dark:bg-blue-950/50 dark:text-blue-300 tabular-nums", children: methods.length })] }), _jsxs("div", { className: "flex flex-row items-stretch min-h-[14rem]", children: [_jsx("nav", { className: "shrink-0 w-44 sm:w-52 border-r border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/60", "aria-label": "Method list", children: _jsx("ul", { className: "p-1.5 space-y-0.5 overflow-y-auto max-h-80", role: "listbox", "aria-label": "Available methods", children: methods.map((name) => {
                            ...
                            }) }) }), _jsxs("div", { className: "flex-1 min-w-0 p-4 sm:p-5 overflow-x-auto bg-white dark:bg-gray-900", children: [_jsxs("div", { className: "mb-4 pb-3 border-b border-gray-100 dark:border-gray-800", children: [_jsx("p", { className: "text-[11px] uppercase tracking-wide text-gray-500 dark:text-gray-400 mb-0.5", children: "Call method" }), _jsx("h3", { className: "text-base sm:text-lg font-semibold text-gray-900 dark:text-white font-mono", children: capitalizeFirstLetter(activeMethod) }), _jsxs("p", { className: "mt-1 text-xs text-gray-500 dark:text-gray-400 font-mono break-all", children: [activeMethod, "(", selectedParams.join(', '), ")"] })] }), _jsx(SmartObjectFunction, { funcName: activeMethod, smartObject: smartObject, functionsExist: true, options: options, setFunctionResult: setFunctionResult, setShow: setShow, setModalTitle: setModalTitle, embedded: true }, activeMethod)] })] })] }));
};
