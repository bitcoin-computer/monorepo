...
export declare const ShowModalButton: ({ id, text }: any) => import("react").JSX.Element;
export declare const HideModalButton: ({ id, text }: any) => import("react").JSX.Element;
export declare const ToggleModalButton: ({ id, text }: any) => import("react").JSX.Element;
...
export declare const Modal: {
    ...
    ShowButton: ({ id, text }: any) => import("react").JSX.Element;
    HideButton: ({ id, text }: any) => import("react").JSX.Element;
    ToggleButton: ({ id, text }: any) => import("react").JSX.Element;
