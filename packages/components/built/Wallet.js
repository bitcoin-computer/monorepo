...
const Loader = () =>
  _jsxs('span', {
    ...
    children: [
      ...
      _jsx('span', { className: 'sr-only', children: 'Loading...' }),
    ],
  })
const BalanceDisplay = ({ balance, chain, network, isRegtest, isRefreshing, onRefresh, onFund }) =>
  _jsxs('div', {
    id: 'dropdown-cta',
    ...
    children: [
      _jsxs('div', {
        className: 'text-center mb-1 text-2xl font-bold text-blue-800 dark:text-blue-400',
        children: [
          bigIntToStr(balance),
          ' ',
          chain,
      ...
      _jsx('div', {
        className: 'text-center uppercase text-xs text-blue-800 dark:text-blue-400',
        children: network,
      }),
      isRegtest &&
        _jsx('button', {
      ...
      _jsxs('div', {
        ...
        children: [
          ...
          _jsx('button', {
            ...
            className:
              'px-3 py-1.5 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 rounded-lg dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700',
            children: withdrawing ? _jsx(Loader, {}) : _jsx(_Fragment, { children: 'Withdraw' }),
          }),
        ],
      }),
    ],
        ...
        children: [
          _jsx('div', {
            children: _jsx('input', {
              ...
              onChange: (e) => setAddress(e.target.value),
              className:
                'block w-full p-1.5 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500',
              placeholder: 'Recipient Address',
            }),
          }),
          _jsx('div', {
            children: _jsxs('div', {
              ...
              children: [
                _jsx('input', {
                  ...
                  className:
                    'block w-full p-1.5 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 [moz-appearance:textfield] focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none',
                  placeholder: '0.00',
                }),
                _jsx('div', {
                  className:
                    'shrink-0 rounded-lg border border-gray-300 bg-gray-50 px-2 py-1.5 text-sm text-gray-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-400',
                  children: computer.getChain(),
                }),
              ],
            }),
          }),
...
const Balance = ({ computer, modSpecs, isOpen }) => {
  ...
  return _jsxs(_Fragment, {
    children: [
      ...
      _jsx(Address, { computer: computer }),
      _jsx('hr', { className: 'h-px my-2 bg-gray-200 border-0 dark:bg-gray-700' }),
      _jsx(WithdrawNew, { computer: computer, modSpecs: modSpecs }),
      _jsx('hr', { className: 'h-px my-2 bg-gray-200 border-0 dark:bg-gray-700' }),
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          _jsx('h6', { className: 'text-lg font-bold dark:text-white', children: label }),
          _jsx('button', {
            onClick: handleCopy,
            className:
              'ml-1 p-1 text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-white',
            'aria-label': `Copy ${label.toLowerCase()}`,
            children: copied
              ? _jsx(FiCheck, { className: 'w-4 h-4 text-green-500 dark:text-green-400' })
              : _jsx(FiCopy, { className: 'w-4 h-4' }),
          }),
        ],
      }),
      _jsx('p', {
        className: 'my-2 font-mono text-xs text-gray-500 dark:text-gray-400 break-words',
        children: value,
      }),
    ],
  })
...
const Address = ({ computer }) =>
  _jsx(CopyableField, { label: 'Deposit Address', value: computer.getAddress() })
const PublicKey = ({ computer }) =>
  _jsx(CopyableField, { label: 'Public Key', value: computer.getPublicKey() })
      ...
      _jsxs('h6', {
        ...
        children: [
          ...
          _jsx('button', {
            ...
            className:
              'text-xs font-mono font-normal text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-500 underline',
            children: shown ? 'hide' : 'show',
          }),
        ],
      }),
      _jsx('p', {
        className: 'text-xs font-mono text-gray-500 dark:text-gray-400 break-words',
        children: shown ? getValue() : '',
      }),
    ],
  })
}
const Mnemonic = ({ computer }) =>
  _jsx(RevealableField, { label: 'Mnemonic', getValue: () => computer.getMnemonic() })
...
const Network = ({ computer }) =>
  _jsx(SimpleField, { label: 'Network', value: computer.getNetwork() })
  ...
  _jsxs(_Fragment, {
    children: [
      _jsxs('div', {
        className: 'my-2',
        children: [
          _jsx('h6', { className: 'text-lg font-bold dark:text-white', children: 'Log Out' }),
          _jsx('p', {
            className: 'mb-1 text-sm text-gray-500 dark:text-gray-400',
            children: 'Logging out will delete your mnemonic. Make sure to write it down.',
          }),
        ],
      }),
      _jsx('button', {
...
export function Wallet({ modSpecs }) {
  ...
  const Content = ({ isOpen }) =>
    _jsxs(_Fragment, {
      children: [
        _jsx('h4', { className: 'text-2xl font-bold dark:text-white', children: 'Wallet' }),
        _jsx(Balance, { computer: computer, modSpecs: modSpecs || [], isOpen: isOpen }),
        _jsx(PublicKey, { computer: computer }),
        _jsx(Mnemonic, { computer: computer }),
        !getEnv('CHAIN') && _jsx(Chain, { computer: computer }),
        !getEnv('NETWORK') && _jsx(Network, { computer: computer }),
        !getEnv('URL') && _jsx(Url, { computer: computer }),
        !getEnv('PATH') && _jsx(Path, { computer: computer }),
        _jsx('hr', { className: 'h-px my-2 bg-gray-200 border-0 dark:bg-gray-700' }),
        _jsx(LogOut, {}),
      ],
    })
