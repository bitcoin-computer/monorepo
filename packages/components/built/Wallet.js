...
const WithdrawNew = ({ computer }) => {
    ...
    return (_jsxs("div", { className: "my-2", children: [_jsx("h6", { className: "text-lg font-bold dark:text-white", children: "Withdraw to Address" }), _jsx("div", { className: "flex items-center space-x-2 my-2", children: _jsx("button", { type: "button", onClick: handleWithdraw, disabled: withdrawing, className: "px-3 py-1.5 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 rounded-lg dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700", children: withdrawing ? _jsx(Loader, {}) : _jsx(_Fragment, { children: "Withdraw" }) }) })] }));
};
