...
const PublicKey = ({ computer }) => {
    ...
    return (_jsxs("div", { className: "my-2", children: [_jsxs("div", { className: "flex items-center", children: [_jsx("h6", { className: "text-lg font-bold dark:text-white", children: "Public Key" }), _jsx("button", { onClick: handleCopy, className: `ml-1 p-1 text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-white`, "aria-label": "Copy public key", children: copied ? (_jsx(FiCheck, { className: "w-4 h-4 text-green-500 dark:text-green-400" })) : (_jsx(FiCopy, { className: "w-4 h-4" })) })] }), _jsx("p", { className: "my-2 text-xs font-mono text-gray-500 dark:text-gray-400 break-words", children: computer.getPublicKey() })] }));
};
const Mnemonic = ({ computer }) => {
    const [mnemonicShown, setMnemonicShown] = useState(false);
    return (_jsxs("div", { className: "my-2", children: [_jsxs("h6", { className: "text-lg font-bold dark:text-white", children: ["Mnemonic", ' ', _jsx("button", { onClick: () => setMnemonicShown(!mnemonicShown), className: "text-xs font-mono font-normal text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-500 underline", children: mnemonicShown ? 'hide' : 'show' })] }), _jsx("p", { className: "text-xs font-mono text-gray-500 dark:text-gray-400 break-words", children: mnemonicShown ? computer.getMnemonic() : '' })] }));
};
const Url = ({ computer }) => (_jsxs("div", { className: "my-2", children: [_jsx("h6", { className: "text-lg font-bold dark:text-white", children: "Node Url" }), _jsx("p", { className: "my-2 font-mono text-xs text-gray-500 dark:text-gray-400 break-words", children: computer.getUrl() })] }));
const Chain = ({ computer }) => (_jsxs("div", { className: "my-2", children: [_jsx("h6", { className: "text-lg font-bold dark:text-white", children: "Chain" }), _jsx("p", { className: "my-2 font-mono text-xs text-gray-500 dark:text-gray-400 break-words", children: computer.getChain() })] }));
const Network = ({ computer }) => (_jsxs("div", { className: "my-2", children: [_jsx("h6", { className: "text-lg font-bold dark:text-white", children: "Network" }), _jsx("p", { className: "my-2 font-mono text-xs text-gray-500 dark:text-gray-400 break-words", children: computer.getNetwork() })] }));
const Path = ({ computer }) => (_jsxs("div", { className: "my-2", children: [_jsx("h6", { className: "text-lg font-bold dark:text-white", children: "Path" }), _jsx("p", { className: "my-2 font-mono text-xs text-gray-500 dark:text-gray-400 break-words", children: computer.getPath() })] }));
