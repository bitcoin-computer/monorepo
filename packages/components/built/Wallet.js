...
const WithdrawNew = ({ computer, modSpecs }) => {
    ...
    return (_jsxs("div", { className: "my-2", children: [_jsx("h6", { className: "text-lg font-bold dark:text-white", children: "Withdraw to Address" }), _jsxs("div", { className: "mt-3 space-y-3", children: [_jsx("div", { children: _jsx("input", { type: "text", value: address, onChange: (e) => setAddress(e.target.value), className: "block w-full p-1.5 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500", placeholder: "Recipient Address" }) }), _jsx("div", { children: _jsxs("div", { className: "flex items-center space-x-2", children: [_jsx("input", { type: "number", inputMode: "decimal", min: "0", step: "0.00000001", value: amount, onChange: (e) => setAmount(e.target.value), className: "block w-full p-1.5 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 [moz-appearance:textfield] focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none", placeholder: "0.00" }), _jsx("div", { className: "shrink-0 rounded-lg border border-gray-300 bg-gray-50 px-2 py-1.5 text-sm text-gray-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-400", children: computer.getChain() })] }) }), _jsx("button", { type: "button", onClick: handleWithdraw, disabled: withdrawing, className: "px-3 py-1.5 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 rounded-lg dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700", children: withdrawing ? _jsx(Loader, {}) : _jsx(_Fragment, { children: "Withdraw" }) })] })] }));
};
const Balance = ({ computer, modSpecs, isOpen, }) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(BalanceDisplay, { balance: balance, chain: computer.getChain(), network: computer.getNetwork(), isRegtest: computer.getNetwork() === 'regtest', isRefreshing: isRefreshing, onRefresh: refreshBalance, onFund: fund }), _jsx(Address, { computer: computer }), _jsx("hr", { className: "h-px my-2 bg-gray-200 border-0 dark:bg-gray-700" }), _jsx(WithdrawNew, { computer: computer, modSpecs: modSpecs }), _jsx("hr", { className: "h-px my-2 bg-gray-200 border-0 dark:bg-gray-700" }), !!VITE_WITHDRAW_MOD_SPEC && (_jsx(Withdraw, { computer: computer, paymentsWrapper: paymentsWrapper, onSuccess: refreshBalance }))] }));
};
