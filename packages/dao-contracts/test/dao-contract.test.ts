...
describe('Election', () => {
  ...
  describe('validVotes', () =>{
    ...
    it.skip('Should compute the valid votes using a transferred token in another election', async () => {
      ...
      const vote1 = await computer.new(Vote, [{electionId: election1._id, tokens:[t1], vote: 'accept'}], voteMod)
      ...
      const vote2 = await computer2.new(Vote, [{electionId: election2._id, tokens:[t2!], vote: 'accept'}], voteMod)
  ...
  describe('acceptingVotes', () => {
    ...
    it.skip('Should count token amounts if the transferred token is used to vote in a different election', async () => {
      ...
      // vote in another election
      await computer2.new(Vote, [{electionId: election2._id, tokens:[t2!], vote: 'accept'}], voteMod)
