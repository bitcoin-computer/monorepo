...
describe('subscribe', () => {
  ...
  it('Should emit when subscribing to asm key field', async () => {
    let eventCount = 0
  ...
  it('Should emit when subscribing to satoshis field', async () => {
    const sats = 50000n
  ...
  it('Should emit when subscribing to mod field', async () => {
    let eventCount = 0
    class Counter extends Contract {
      n: number
  ...
  it('Should emit when subscribing to expression field', async () => {
    let eventCount = 0
